...
plt.grid()
plt.tight_layout()
plt.savefig("/home/hung/fraud_detection/src/images/xgboost/roc_curve.png")
plt.close()
...
plt.figure(figsize=(8, 6))
plt.plot(recall, precision, label=f"Precision-Recall Curve (AUCPR = {aucpr:.4f})", color='green')
plt.xlabel("Recall")
...
plt.grid()
plt.tight_layout()
plt.savefig("/home/hung/fraud_detection/src/images/xgboost/pr_curve.png")
plt.close()
...
plt.tight_layout()
plt.savefig("/home/hung/fraud_detection/src/images/xgboost/feature_importance.png")
plt.close()
...
plt.grid(True)
plt.legend()
plt.savefig("/home/hung/fraud_detection/src/images/xgboost/gain_chart.png")
plt.close()
...
plt.grid(True)
plt.savefig("/home/hung/fraud_detection/src/images/xgboost/gain_chart_threshold.png")
plt.close()
